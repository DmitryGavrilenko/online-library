...
import com.database.BookList;
import java.util.ArrayList;
import com.connectiondatabase.DatabaseConnection;
import com.database.Genre;
...
DatabaseConnection db = new DatabaseConnection();
      ...
      synchronized (_jspx_page_context) {
        ...
        if (genre == null){
          ...
          out.write("        ");
for (Genre genre : genre.getGenreList()) {
          out.write("\n");
          out.write("        <a id=\"genre_link\" href=\"book.jsp?genre_id=");
          out.print(genre.getId());
          out.write("&gnreName=");
          out.print(genre.getName());
          out.write("\">\n");
          out.write("            <li id=\"author_li\">");
          out.print(genre.getName());
          out.write("</li></a>    \n");
          out.write("        ");
}
      ...
      out.write("    ");
      com.database.BookList bookList = null;
      synchronized (_jspx_page_context) {
        bookList = (com.database.BookList) _jspx_page_context.getAttribute("bookList", PageContext.PAGE_SCOPE);
        if (bookList == null){
          bookList = new com.database.BookList();
          _jspx_page_context.setAttribute("bookList", bookList, PageContext.PAGE_SCOPE);
          out.write("\n");
          out.write("    ");
for (Book books : bookList.getBooksByGenre(12)) {
          out.write("\n");
          out.write("    <li>");
          out.print(books.getId());
          out.write("</li>\n");
          out.write("    <li>");
          out.print(books.getName());
          out.write("</li>\n");
          out.write("    <li>");
          out.print(books.getGenre());
          out.write("</li>\n");
          out.write("    <li>");
          out.print(books.getAuthor());
          out.write("</li>\n");
          out.write("        ");
}
          out.write("\n");
